...
action_data = {"score": 6666, "times": 666}

session_id = "iGGuJbf+J6Mko/KTIuRjNK2+O7ilpsQpi5w1RmJQZ4aSWbtmsj9EOA5Xozl77NN8eLdcB6IEfynZ0itjqvXP28kdNn0xBeHuUkBmpk9jtd+6JDok8xoS+plqwXn9wK1TrzlbFxlrG3xB6uyARZmO9w=="
...
headers = {
    ...
    "gzip",
    "referer":
    "https://servicewechat.com/wx7c8d593b2c3a7703/3/page-frame.html",
    "content-type":
    "application/json",
    "User-Agent":
    "MicroMessenger/6.6.1.1200(0x26060130) NetType/WIFI Language/zh_CN",
    "Content-Length":
    "0",
    "Host":
    "mp.weixin.qq.com",
